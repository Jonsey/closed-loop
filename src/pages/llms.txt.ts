...
export const GET: APIRoute = async ({ site }) => {
  ...
  const lines = [
    ...
    `consulting. Contact: hello@closed-loop.dev — see ${new URL('/services/', site)}`,
    '',
    '## Articles',
    '',
    ...posts.map(
    ...
    `- [How we work](${new URL('/how-we-work/', site)}): how engagements are diagnosed (constraint), measured (one KPI) and priced (10–20% of first-year value), with a calculator`,
